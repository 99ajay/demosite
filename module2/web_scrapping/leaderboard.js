    ...
    if (error) {
        ...
        for (let i = 0; i < playerDetail.length; i++) {
            ...
            if (counter == 0) {
                ...
                let data_exel = [
                    {
                        sheet: "ipl_status",
                        columns: [
                            { label: "Name_of_player", value: "Name" }, // Top level data
                            { label: "Run", value: "Runs" }, // Custom format
                            { label: "Balls", value: "Balls" }, // Run functions
                            { label: "Four", value: "Fours" },
                            { label: "Six", value: "Sixes" },
                        ],
                        content: leaderboard
                ...
                xlsx(data_exel, settings) // Will download the excel file
            }
